  ...
  return (
    <div className="introduction-container">
      ...
      <section>
        ...
        <p>
          Once upon a time, on an Earth that never was, the citizens of that
          fair planet were facing an unprecedented crisis. A star-faring race of
          reptilian predators had come to swallow the Milky Way, and they did
          not care for peace or compromise. The inhabitants of Earth feared for
          the future, and they grew desperate after it became clear that only
          one end awaited them, should they lose this war. The reptiles had sent
          videos of their monstrous feeding vats. They were indifferent to cries
          for mercy, and amused by the threats, prayers, and attempts at
          bargaining. Their answer was always the same: human in, goo out.
        </p>
        <i>--Reptile hunkered over feeding vat image--</i>
        <p>
          Naturally, the humans could not let this stand. So, they set in motion
          a plan. An organization was born, a juggernaut of such proportions
          that it dwarfed anything seen in the short history of homo sapiens.
          This organization had many parts and many purposes. But it was clear
          that it lurched toward a singular goal. The machinery of war would be
          realized in weapons of hitherto unimaginable destructive power, and
          the components that made up those weapons would be built by
          specialized teams of Earth’s finest engineers.
        </p>
        <i>--mega organization, led by council image--</i>
        <p>
          The council that oversaw this organization had placed their hopes, and
          a substantial portion of Earth’s resources, on a very special weapon.
          This weapon was named—perhaps unwisely—the Godzilla Beam. It was a
          long-range ground-to-orbit gravity fluctuator. The physicists dreamt
          it up, the mathematicians validated the empirical models, and it was
          now up to the engineers to carry the torch forward. An artifact of
          such daunting complexity had never before been concretely conceived
          of, let alone built. The engineers were skeptical, most did not think
          the project could succeed. But if the alternative was a goo vat, all
          they could do was shrug, roll up their sleeves, and let the dice roll.
        </p>
